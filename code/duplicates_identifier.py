...
in_parms = dict(in_path = '/home/albanero/PycharmProjects/in-de-codepair-template-python/data/',
                in_file_1 = 'in_data.csv')
out_parms = dict(out_path = '/home/albanero/PycharmProjects/in-de-codepair-template-python/data_out/')

def get_list_of_dup_col():
    dup_cols = {}
    conf_file = open('../config/duplicate_column_list.conf', "r")
